...
//++++++++++++++++++++++++++++++When the hero hits the platform from above or below
  collisions() {
  for(let i = 0 ; i < 20 ; i++) {
    if(this.loc.y + 7.60 > game.platforms[i].loc.y
    && this.loc.y + 7.60 < game.platforms[i].loc.y + 10
    && this.loc.x + 7.60 > game.platforms[i].loc.x
    && this.loc.x + 7.60 < game.platforms[i].loc.x + 40){
